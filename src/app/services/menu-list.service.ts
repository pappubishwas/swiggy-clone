...
export class MenuListService {
  ...
  restaurantCards = [
    {
      imageUrl:
        'https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/RX_THUMBNAIL/IMAGES/VENDOR/2024/10/24/a515c573-f6bd-48bc-99b3-cda9edeb1ac4_559248.JPG',
    ...
    {
      imageUrl:
        'https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/RX_THUMBNAIL/IMAGES/VENDOR/2024/7/17/53d5f5b4-1e37-4855-8f11-aa5ef1d12d47_408185.jpg',
    ...
    {
      imageUrl:
        'https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/RX_THUMBNAIL/IMAGES/VENDOR/2024/11/5/db2f458b-9036-4826-9dc1-bcd9c758ff80_75280.JPG',
      ...
      items: [
        {
          ...
          price: 249,
          description:
            'Classic cheese pizza with a fresh tomato base and herbs.',
        },
        {
          itemId: '1',
          imgUrl:
          ...
          price: 369,
          description:
            'Loaded with tender chicken, bell peppers, and mozzarella.',
        },
        {
          itemId: '2',
          imgUrl:
        ...
        },
        {
          ...
          price: 299,
          description:
            'Spicy tandoori paneer toppings with onions and capsicum.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          price: 199,
          description:
            'Signature Whopper with flame-grilled patty, lettuce, and mayo.',
        },
        {
          itemId: '1',
          imgUrl:
        ...
        },
        {
          ...
          price: 99,
          description:
            'Thick and creamy vanilla shake topped with whipped cream.',
        },
        {
          itemId: '4',
          imgUrl:
          ...
          price: 249,
          description:
            'Burger with crispy, spicy chicken patty and fresh veggies.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          price: 179,
          description:
            'Fresh veggie sub with tomatoes, cucumbers, and lettuce.',
        },
        {
          itemId: '1',
          imgUrl:
        ...
        },
        {
          ...
          price: 239,
          description:
            'Lean turkey breast with fresh toppings and your choice of sauce.',
        },
        {
          itemId: '3',
          imgUrl:
          ...
          price: 50,
          description:
            'Classic cookie with chocolate chips baked to perfection.',
        },
        {
          itemId: '4',
          imgUrl:
  ...
  getRestaurantByName(name: string) {
    const restaurant = this.restaurantWithItems.find(
